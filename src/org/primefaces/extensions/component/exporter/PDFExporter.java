            ...
            while (st.hasMoreElements()) {
                ...
                if (tableTitle != null && !tableTitle.isEmpty() && !tableId.contains(",")) {
                    ...
                    if (fontName != null) { 
                        ...
                        tableTitleFont = FontFactory.getFont(fontName, encodingType, BaseFont.EMBEDDED,Font.DEFAULTSIZE, Font.BOLD );
                    }
                    else
                        tableTitleFont = FontFactory.getFont(FontFactory.TIMES, encodingType, Font.DEFAULTSIZE, Font.BOLD);
...
//        }
        if (fontName != null) {
            FontFactory.registerDirectories();
            this.cellFont = FontFactory.getFont(fontName, encoding, BaseFont.EMBEDDED);
            this.facetFont = FontFactory.getFont(fontName, encoding, BaseFont.EMBEDDED, Font.DEFAULTSIZE, Font.BOLD);
        } else {
